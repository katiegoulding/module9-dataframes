...
# QUIZ SECTION HW HELP
# people$ages[people$ages == max(people$ages)]
# This returns the largest age in the dataset

# setwd("~"/something/MyDaya/Dogs)
  read.csv("relative")
...
#One option:
num.raises <- salaries$got.raise[salaries$got.raise == TRUE]
length(num.raises)
View(salaries)
